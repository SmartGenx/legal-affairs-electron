...
import AgencyPdf from './Agency-pdf'

export interface propDetails {
  data: AgencyInfo[]
}
export default function TopButtons({ data }: propDetails) {
  const [dataPrint, setDataPrint] = useState<AgencyInfo[] | any[]>([])
...
const ExportCvs = () => {
  ...
  const fileName = 'جدول التوكيلات.xlsx'
          ...
          <DropdownMenuContent className="min-w-[180px]">
            <DropdownMenuGroup>
              ...
              <div className="hidden">
                <AgencyPdf ref={componentRef} data={data || []} />
              </div>
              <DropdownMenuItem className=" flex gap-2">
                {/* <AccountBalanceIcon /> */}
