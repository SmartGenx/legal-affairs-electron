...
const FilterDrawer = () => {
  ...
  const handleClearFilters = () => {
    navigate('/generalization', { replace: true })
  }
  const handleFilter = () => {
    ...
    if (reference) {
      params.set('refrance[equals]', reference)
    }

    setIsOpen(false)
    navigate(`/generalization?${params.toString()}`, { replace: true })
  }
    ...
    <Drawer open={isOpen} onOpenChange={setIsOpen} direction="left">
      ...
      <DrawerContent className="w-fit max-w-sm bg-white">
        ...
        <div className="p-6 overflow-y-auto">
          <h3 className="text-base font-semibold text-[#383838] mb-2 mt-4">البحث برقم التعميم</h3>

          <div>
            <input
              placeholder="ادخل رقم التعميم"
              type="text"
