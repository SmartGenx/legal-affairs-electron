...
export function OrganizationTable<TData, TValue>({
  ...
  return (
    <>
      ...
      >
        <Table className="relative border-separate border-spacing-y-0 rounded-lg   bg-[#ebebf7] ">
      ...
      <TablePagination total={total} page={parseInt(page, 10) || 1} pageSize={pageSize || 0} />
    </>
  )
}
