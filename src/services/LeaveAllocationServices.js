    ...
    try {
      ...
      if (!existingAllocation) {
        throw new NotFoundError(
          `employ for employeeId ${employeeId} is not exist.`
        );
      }
      ...
      console.log("🚀 ~ LeaveAllocationService ~ createLeaveAllocation ~ existingLeaveType:", existingLeaveType)
      if (!existingLeaveType) {
        throw new NotFoundError(
          `leavetype for leavetypeId ${leavetypeId} is not exist.`
        );
      }
