...
class StateIssueAgencyControllers {
  async getAllStateIssueAgencys(req, res, next) {
    try {
      ...
      const StateIssueAgencys =
        await StateIssueAgencyService.getAllStateIssueAgencys(StateIssueAgencyFilter)
  ...
  async createStateIssueAgency(req, res, next) {
    try {
      ...
      const StateIssueAgency =
        await StateIssueAgencyService.createStateIssueAgency(StateIssueAgencyData)
  ...
  async updateStateIssueAgency(req, res, next) {
    ...
    try {
      ...
      const StateIssueAgencyData = req.body
      const StateIssueAgency = await StateIssueAgencyService.updateStateIssueAgency(
        id,
        StateIssueAgencyData
      )
      if (!StateIssueAgency) {
        return next(new NotFoundError(`StateIssueAgency with id ${id} not found.`))
      }
